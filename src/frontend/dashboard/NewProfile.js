...
const NewProfile = ({ user }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // Set user details in Firebase Authentication
      await updateProfile(user, {
        displayName: name,
        phoneNumber:  data.phone,
        photoURL:'/images/penguine.png'
      });
      ...
      alert.success("Profile saved successfully! A verification email has been sent to your email address.");
    } catch (error) {
