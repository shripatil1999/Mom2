  ...
  return (
    <GlobalLayout>
      <div
        ...
        className="bg-[#e3f2fd21]  p-5 flex mt-3 mr-6"
      >
        ...
        <div className="w-full">
          <div className="about">
            ...
            <p>MoM V 01.001</p>
            <p className="font-bold mb-3 mt-4">Supported Browsers</p>
      ...
      <p className="text-center my-4" >Developed with <i className="bi bi-suit-heart-fill text-red-600"></i> by <a className="text-blue-500 underline hover:text-red-600" href="https://www.pumpacademy.in/" target="_blank" rel="noreferrer">@PAPL</a></p>
    </GlobalLayout>
  );
};
