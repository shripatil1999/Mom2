            ...
            try {
                ...
                const unsubscribe = onSnapshot(q, (querySnapshot) => {
                    ...
                    querySnapshot.forEach((doc) => {
                        ...
                        console.log("meetingData", meetingData.attendees)
                        if (meetingData.attendees && meetingData.attendees.find(attendee => attendee.attendeeName === currentUser.displayName)) {
                            fetchedMeetings.push(meetingData);
            ...
            <div className="flex">
                <div>
                    ...
                    {meetings.map((meet, index) => (
                        <div
                            key={index}
                            className="space-y-2 mt-4 overflow-y-auto max-h-[calc(100vh)]"
                        >
                    ...
                    selectedMeeting && (
                        <div className="w-3/4 p-4 m-2 shadow-sm border bg-slate-50 border-blue-600">
                            ...
                            <div className="flex justify-between my-2">
                                <p className="">
                                    <span className="font-semibold uppercase">Meet Code: </span>
                                ...
                                <div className="attendees">
                                    ...
                                    <div className="flex flex-wrap">
                                        {selectedMeeting.attendees.map((attend, index) => (
                                            <span
                                                className="border-1 bg-blue-200 border-blue-900 p-2 m-1 shadow-sm shadow-blue-900"
                                                key={index}
                                            >
                                                {attend.attendeeName}
                                            </span>
