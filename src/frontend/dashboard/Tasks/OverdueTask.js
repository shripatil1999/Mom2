                ...
                for (const id of documentIds) {
                    ...
                    if (taskDoc && taskDoc.data()) {
                        ...
                        if (taskData && Object.keys(taskData).length > 0) {
                            ...
                            // Filter tasks based on user and target date
                            const matchingTasks = tasks.filter((task) => {
                                return (
                                    (task.actionBy === user || (task.supporters && task.supporters.includes(user))) &&
                                    (task.targetDate && isBefore(new Date(task.targetDate.seconds * 1000), startOfToday()))
                                    && (task.status && task.status !== "Completed") && (task.status && task.status !== "Ongoing")
                                );
                            });
        ...
        <GlobalLayout>
            {
                tasks.length > 0 ? (
                    <>
                        <div className="bg-red-500 w-[99%] text-white text-center text-base p-1">
                        ...
                        <Menu as="div" className="relative inline-block text-left w-full">
                            ...
                            >
                                ...
                                <div className="side-list h-fit p-2 flex flex-col mt-2 gap-4">
                                    {/* Your vertical tabs */}
                                    <Tab.Group
                                                ...
                                                <div className="first-strip shadow-sm  flex items-center justify-between p-2 border px-4 ">
                                                    <div className="dropdown">
                                                        ...
                                                        >
                                                            ...
                                                            <option className="border-red-500 bg-red-50" value="Overdue">Overdue</option>
                    ...
                    <div>
                        <div class="flex items-center justify-center">
                            <img src="images/icons/overduetasks.png" alt="No tasks" class="w-[30%] h-fit" />
                        </div>
                        <p class="text-center text-2xl font-bold text-gray-600 mt-2">No tasks are overdue</p>
                    </div>
            }
