    ...
    <>
      <div className="grid grid-cols-8 border-bottom gap-0">
        <div style={{
          ...
          <p style={{ fontSize: '1.1em', marginLeft: '14%' }} className=' text-blue-600 font-bold drop-shadow'>Minutes of Meeting</p>
        </div>
        {/* //progress bar */}
        ...
        <div className="col-span-1 h-full flex items-center ">
          <div className="w-full bg-gray-200 rounded-full">
            <div className="bg-blue-600 text-sm font-medium text-blue-100 text-center p-1 leading-none rounded-full" style={{ width: value }}> {value}</div>
          </div>
        </div>
        ...
        <div className="col-span-1 h-full">
          <div className="user flex flex-col items-center py-2">
